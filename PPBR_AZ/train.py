...
minority_class_counts = {c: max(1000, n_samples) for c, n_samples in class_counts.items() if n_samples < 1000}
majority_class_counts = {c: min(1000, n_samples) for c, n_samples in class_counts.items() if n_samples > 1000}
