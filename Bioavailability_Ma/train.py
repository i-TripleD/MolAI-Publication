...
minority_class_counts = {c: max(500, n_samples) for c, n_samples in class_counts.items() if n_samples < 400}
majority_class_counts = {c: min(500, n_samples) for c, n_samples in class_counts.items() if n_samples > 400}
