...
minority_class_counts = {c: max(10000, n_samples) for c, n_samples in class_counts.items() if n_samples < 10000}
majority_class_counts = {c: min(10000, n_samples) for c, n_samples in class_counts.items() if n_samples > 10000}
