...
minority_class_counts = {c: max(7000, n_samples) for c, n_samples in class_counts.items() if n_samples < 7000}
majority_class_counts = {c: min(7000, n_samples) for c, n_samples in class_counts.items() if n_samples > 7000}
